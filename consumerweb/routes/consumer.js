...
router.get('/', function (req, res, next) {
    var proxy_host = process.env.HTTP_PROXY_HOST || '49.4.70.143';
    var proxy_port = process.env.HTTP_PROXY_PORT || '30004'; // 30101
    ...
    var opt = {
        ...
        port: proxy_port,
        method: 'GET',
        path: 'http://' + service_addr + '/consumer/v0/sell?name=' + req.query.name,
        headers: {}
    };
    if (req.query.user) {
